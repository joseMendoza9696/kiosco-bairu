...
import { OpcionMenu } from '../../../interfaces/menu.interface';
...
const Productos = () => {
  ...
  const categoriaSeleccionada = useSelector(
    // @ts-ignore
    (state: RootState) => state.nuevaOrdenReducer.categoriaSeleccionada,
  );
  ...
  // Verificar si hay productos disponibles en la categoria seleccionada
  if (
    !categoriaActual ||
  ...
  return (
    <div className="pt-10 text-center ">
      ...
      >
        {/* Lógica para elegir el modal type */}
        { OpcionMenu > 0
         ? (
          <Modal2
